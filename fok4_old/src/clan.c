...
*/
    ...
    for ( pArea = area_first; pArea; pArea = pArea->next ) {
	if (pArea->worth > 0) {
	sprintf(area_line,"          {B(%-30s) owned by {W%s{x\n\r",pArea->name,pArea->owner);
...
void do_Kingdom_edit(CHAR_DATA *ch, char *argument)
{
 ...
 if (!str_cmp(arg2,"show"))
    ...
    sprintf(buf,"{cRank 10: %-20s %-20s",kingdom_table[number].rank_titles[9],
		kingdom_table[number].rank_titlesf[9]);
    send_to_char(buf,ch);send_to_char("\n\r",ch);
    sprintf(buf,"{cRank 9:  %-20s %-20s",kingdom_table[number].rank_titles[8],
		kingdom_table[number].rank_titlesf[8]);
    send_to_char(buf,ch);send_to_char("\n\r",ch);
    sprintf(buf,"{cRank 8:  %-20s %-20s",kingdom_table[number].rank_titles[7],
		kingdom_table[number].rank_titlesf[7]);
    send_to_char(buf,ch);send_to_char("\n\r",ch);
    sprintf(buf,"{cRank 7:  %-20s %-20s",kingdom_table[number].rank_titles[6],
		kingdom_table[number].rank_titlesf[6]);
    send_to_char(buf,ch);send_to_char("\n\r",ch);
    sprintf(buf,"{cRank 6:  %-20s %-20s",kingdom_table[number].rank_titles[5],
		kingdom_table[number].rank_titlesf[5]);
    send_to_char(buf,ch);send_to_char("\n\r",ch);
    sprintf(buf,"{cRank 5:  %-20s %-20s",kingdom_table[number].rank_titles[4],
		kingdom_table[number].rank_titlesf[4]);
    send_to_char(buf,ch);send_to_char("\n\r",ch);
    sprintf(buf,"{cRank 4:  %-20s %-20s",kingdom_table[number].rank_titles[3],
		kingdom_table[number].rank_titlesf[3]);
    send_to_char(buf,ch);send_to_char("\n\r",ch);
    sprintf(buf,"{cRank 3:  %-20s %-20s",kingdom_table[number].rank_titles[2],
		kingdom_table[number].rank_titlesf[2]);
    send_to_char(buf,ch);send_to_char("\n\r",ch);
    sprintf(buf,"{cRank 2:  %-20s %-20s",kingdom_table[number].rank_titles[1],
		kingdom_table[number].rank_titlesf[1]);
    send_to_char(buf,ch);send_to_char("\n\r",ch);
    sprintf(buf,"{cRank 1:  %-20s %-20s",kingdom_table[number].rank_titles[0],
 ...
 if (!str_cmp(arg2,"name"))
         {
          sprintf(old,"%s",kingdom_table[number].name);
          kingdom_table[number].name = str_dup(arg3);
          sprintf(buf,"Kingdom %s Renamed to %s.\n\r",old,kingdom_table[number].name);
          send_to_char(buf,ch);
          do_save_clans(ch,"");
          return;
         }
