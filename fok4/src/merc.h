...
typedef struct  mob_memory		MOB_MEMORY;
/*
...
struct mob_memory
{
	...
	CHAR_DATA *  target;
	int			 value;
	int			 age; //how long has the mob remembered the specific person
};
/*
...
#define WEAPON_ACID	(J)
#define WEAPON_SOUND (K)
#define WEAPON_LIGHTNING (L)
#define WEAPON_NEGATIVE (M)
#define WEAPON_DROWNING (N)
#define WEAPON_HARM (O)
#define WEAPON_DISEASE (P)
#define WEAPON_ENERGY (Q)
...
struct	pc_data
{
    ...
    sh_int		learned_effectiveness[MAX_SKILL];
    sh_int		learned_memory[MAX_SKILL];
...
//    sh_int	class_effectiveness[MAX_CLASS];
//    sh_int	race_effectiveness[MAX_RACE];
    sh_int objectDissallow[5];
...
extern  sh_int  gsn_master_sight;
...
extern sh_int	gsn_torturer;
extern sh_int	gsn_agony;
extern sh_int 	gsn_storm_vengeance;
extern sh_int	gsn_arcane_power;
 /*
 * Utility macros.
 */
...
extern	const	struct	npc_class_type	npc_class_table	[];
...
/*Data files for fate of kingdom IV*/
#define FOK4_CLASS_DIR  "../data/class/"
#define FOK4_RACE_DIR  "../data/race/"
...
#define WEBRACE_FILE     "../../../html/race.html" /* For 'bug' and bug()*/
#define WEB_CLASS_FILES        "../../../html/data/classes/" /* For 'bug' and bug()*/
...
// Creation.c
void Creation_name	args( (DESCRIPTOR_DATA *d,CHAR_DATA *ch, char *argument ) );
void Creation_password	args( ( DESCRIPTOR_DATA *d,CHAR_DATA *ch, char *argument ) );
void Creation_confirm	args( ( DESCRIPTOR_DATA *d,CHAR_DATA *ch, char *argument ) );
void Creation_race	args( ( DESCRIPTOR_DATA *d,CHAR_DATA *ch, char *argument ) );
void Creation_sex	args( ( DESCRIPTOR_DATA *d,CHAR_DATA *ch, char *argument ) );
void Creation_class	args( ( DESCRIPTOR_DATA *d,CHAR_DATA *ch, char *argument ) );
void Creation_stats	args( ( DESCRIPTOR_DATA *d,CHAR_DATA *ch, char *argument ) );
void Creation_alignment	args( ( DESCRIPTOR_DATA *d,CHAR_DATA *ch, char *argument ) );
void Creation_hometown	args( (DESCRIPTOR_DATA *d,CHAR_DATA *ch, char *argument ) );
void Creation_ethos	args( ( DESCRIPTOR_DATA *d,CHAR_DATA *ch, char *argument ) );
...
void save_web args ((int num));

void config_race args( ( CHAR_DATA *ch, char *argument ));
/* handler.c */
void 	getpidmud		args( () );
...
int find_gate_mobile_in_zone args( ( CHAR_DATA *ch ) );
...
void do_gouge		args( ( CHAR_DATA *ch, char *argument ) );
...
void save_copyover_obj 	args ( ( void ) );
void load_copyover_obj 	args ( ( void ) );

void do_owhere		args ( (CHAR_DATA *ch, char *argument ) );
/*top.c*/
