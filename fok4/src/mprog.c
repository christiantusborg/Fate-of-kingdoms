   ...
   || ( obj->pIndexData->vnum == 12217 ))
     {
      if (((obj1 = get_obj_carry(mob,"QO1" , NULL)) != NULL)
       ...
       && ((obj3 = get_obj_carry(mob,"QO3" , NULL)) != NULL))
       {
         ...
         extract_obj( obj3);
					interpret(mob, "smile" );
					do_say(mob, "It seem like i have all i need now.");
					interpret(mob, "emote starts make something." );
      	...
      	do_say(mob, "This a nice object i really think i use for something useful, just more useful objects.");
     }
  else
   {
   	do_say(mob, "This object is no good when i need to make magic rings.");
   } 
