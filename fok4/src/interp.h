...
DECLARE_DO_FUN( do_Kingdom_edit );
DECLARE_DO_FUN( do_scatter );
//DECLARE_DO_FUN( do_immtitle );
DECLARE_DO_FUN( do_dance );
DECLARE_DO_FUN( do_show_top_rp );
DECLARE_DO_FUN( do_wealthregulator );
DECLARE_DO_FUN( do_objectfind );
DECLARE_DO_FUN( do_new_say_ooc );
DECLARE_DO_FUN( do_admintalk );
DECLARE_DO_FUN( do_kingdomchannel);
DECLARE_DO_FUN( arena_main );
...
DECLARE_DO_FUN( do_trohpy );
DECLARE_DO_FUN( do_imptalk );
DECLARE_DO_FUN( do_4score );
DECLARE_DO_FUN( do_character );
DECLARE_DO_FUN( do_race );
DECLARE_DO_FUN( do_check );
DECLARE_DO_FUN( do_dpxp );
DECLARE_DO_FUN( do_access_power );
