...
{ "down",	do_down,	POS_STANDING,GROUP_MORTAL,0,auth_move,LOG_NEVER, 1, CMD_KEEP_HIDE|CMD_GHOST|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
     ...
     */
{ "job",	do_job,      	POS_RESTING,	GROUP_MORTAL,0, auth_job,LOG_NORMAL,1 },
{ "arena",	do_war,		POS_STANDING,	GROUP_MORTAL,0, auth_arena,LOG_NORMAL, 1, CMD_KEEP_HIDE|CMD_GHOST|CMD_KEEP_DIMENSION  },
{ "at",		do_at,          POS_DEAD,	GROUP_IMMORT,L5,auth_at,LOG_NORMAL, 1, CMD_KEEP_HIDE|CMD_GHOST|CMD_KEEP_DIMENSION  },
{ "cast",	do_cast,	POS_FIGHTING,	GROUP_MORTAL,0,	auth_cast,LOG_NORMAL, 1,CMD_KEEP_DIMENSION},
{ "commune",	do_commune,	POS_FIGHTING,	GROUP_MORTAL,0,	auth_commune,LOG_NORMAL, 1,CMD_KEEP_DIMENSION},
{ "sing",	do_sing,	POS_FIGHTING,	GROUP_MORTAL,0,	auth_sing,LOG_NORMAL, 1,CMD_KEEP_DIMENSION},
{ "auction",    do_auction,     POS_SLEEPING,	GROUP_MORTAL,0, auth_auction,LOG_NORMAL, 1, CMD_GHOST },
{ "buy",	do_buy,		POS_RESTING,	GROUP_MORTAL,0,	auth_buy,LOG_NORMAL, 1, CMD_KEEP_FADE|CMD_KEEP_DIMENSION},
...
{ "get",	do_get,		POS_RESTING,	GROUP_MORTAL,0,	auth_get,LOG_NORMAL, 1, CMD_KEEP_HIDE|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
...
{ "kill",	do_kill,	POS_FIGHTING,	GROUP_MORTAL,0,	auth_kill,LOG_NORMAL, 1,0},
...
{ "order",	do_order,	POS_RESTING,	GROUP_MORTAL,0,	auth_order,LOG_ALWAYS,1,CMD_KEEP_FADE|CMD_KEEP_DIMENSION},
...
{ "startarena",	do_startwar,	POS_STANDING,	GROUP_MORTAL,0, auth_startarena,LOG_ALWAYS, 1, CMD_KEEP_HIDE|CMD_GHOST|CMD_KEEP_DIMENSION },  
{ "tell",	do_tell,	POS_RESTING,	GROUP_MORTAL,0,	auth_tell,LOG_NORMAL, 1, CMD_GHOST|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
{ "unlock",     do_unlock,      POS_RESTING,	GROUP_MORTAL,0, auth_unlock,LOG_NORMAL, 1,0},
{ "vt",		do_vt,		POS_DEAD,	GROUP_MORTAL,0,	auth_vt,LOG_NORMAL, 1 }, 
{ "wield",	do_wear,	POS_RESTING,	GROUP_MORTAL,0,	auth_wield,LOG_NORMAL, 1,CMD_KEEP_DIMENSION},
{ "dual",	do_second,	POS_RESTING,	GROUP_MORTAL,0,	auth_second,LOG_NORMAL,1,CMD_KEEP_DIMENSION},
...
{ "arenaout",	do_arenaout,	POS_DEAD,	GROUP_MORTAL,0,	auth_arenaout,LOG_NORMAL,1, CMD_KEEP_HIDE|CMD_GHOST|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
...
{ "finger",	do_finger,	POS_DEAD,	GROUP_MORTAL,L4, auth_finger,LOG_NORMAL, 1,CMD_KEEP_HIDE|CMD_GHOST|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
...
{ "emote",	do_emote,	POS_RESTING,	 GROUP_MORTAL,0,auth_emote,LOG_NORMAL, 1, CMD_GHOST|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
{ "pmote",	do_pmote,	POS_RESTING,	 GROUP_MORTAL,0,auth_pmote,LOG_NORMAL, 1, CMD_GHOST|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
{ ",",		do_emote,	POS_RESTING,	 GROUP_MORTAL,0,auth_emote,LOG_NORMAL, 0, CMD_GHOST|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
...
{ "newbie",	do_newbie,	POS_SLEEPING,	 GROUP_MORTAL,0,auth_newbie,LOG_NORMAL, 1, CMD_GHOST|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
{ "note",	do_note,	POS_SLEEPING,	 GROUP_MORTAL,0,auth_note,LOG_NORMAL, 1, CMD_KEEP_HIDE|CMD_GHOST|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
{ "pose",	do_pose,	POS_RESTING,	 GROUP_MORTAL,0,auth_pose,LOG_NORMAL, 1, CMD_GHOST|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
{ "ooc",	do_ooc,		POS_SLEEPING,	 GROUP_MORTAL,0,auth_ooc,LOG_NORMAL, 1, CMD_GHOST|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
{ "gossip",	do_gossip,	POS_SLEEPING,	 GROUP_MORTAL,0,auth_gossip,LOG_NORMAL, 1, CMD_GHOST|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
...
{ "shout",	do_shout,	POS_RESTING,	 GROUP_MORTAL,0,auth_shout,LOG_NORMAL, 1, CMD_GHOST|CMD_KEEP_DIMENSION },
{ "message",	do_shout,	POS_RESTING,	 GROUP_MORTAL,0,auth_shout,LOG_NORMAL, 1, CMD_GHOST|CMD_KEEP_DIMENSION },
{ "warcry",     do_warcry,      POS_FIGHTING,    GROUP_MORTAL,0,auth_warcry,LOG_NORMAL, 1,CMD_KEEP_DIMENSION},
{ "dark",	do_dark_vision, POS_STANDING,	 GROUP_MORTAL,0,auth_dark_vision,LOG_NORMAL, 1,CMD_KEEP_DIMENSION},
{ "detect",     do_detect_hidden,POS_RESTING,    GROUP_MORTAL,0,auth_detect_hidden,LOG_NORMAL, 1,CMD_KEEP_DIMENSION},
{ "bearcall",   do_bear_call,   POS_FIGHTING,    GROUP_MORTAL,0,auth_bear_call,LOG_NORMAL, 1,CMD_KEEP_DIMENSION},
{ "yell",	do_yell,	POS_RESTING,	 GROUP_MORTAL,0,auth_yell,LOG_NORMAL, 1, CMD_GHOST|CMD_KEEP_DIMENSION },
...
{ "pray",       do_pray,        POS_DEAD,        GROUP_MORTAL,0,auth_pray,LOG_NORMAL, 1, CMD_KEEP_HIDE|CMD_GHOST|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
     ...
     */
{ "brandish",	do_brandish,	POS_RESTING,	 GROUP_MORTAL,0,auth_brandish,LOG_NORMAL, 1,CMD_KEEP_DIMENSION },
{ "butcher",    do_butcher,     POS_STANDING,    GROUP_MORTAL,0,auth_butcher,LOG_NORMAL, 1,0 },
...
{ "lore",       do_lore,        POS_RESTING,     GROUP_MORTAL,0,auth_lore,LOG_NORMAL, 1,CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
{ "open",	do_open,	POS_RESTING,	 GROUP_MORTAL,0,auth_open,LOG_NORMAL, 1,CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
{ "pick",	do_pick,	POS_RESTING,	 GROUP_MORTAL,0,auth_pick,LOG_NORMAL, 1,CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
{ "relock",	do_relock,	POS_RESTING,	 GROUP_MORTAL,0,auth_relock,LOG_NORMAL, 1,CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
...
{ "quaff",	do_quaff,	POS_RESTING,	 GROUP_MORTAL,0,auth_quaff,LOG_NORMAL, 1,CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
{ "recite",	do_recite,	POS_RESTING,	 GROUP_MORTAL,0,auth_recite,LOG_NORMAL, 1,CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
//{ "camp",	do_camp,	POS_STANDING,	 GROUP_MORTAL,0,auth_camp,LOG_NORMAL,1,0},
{ "remove",	do_remove,	POS_RESTING,	 GROUP_MORTAL,0,auth_remove,LOG_NORMAL, 1,CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
...
{ "wear",	do_wear,	POS_RESTING,	 GROUP_MORTAL,0,auth_wear,LOG_NORMAL, 1,CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
{ "zap",	do_zap,		POS_RESTING,	 GROUP_MORTAL,0,auth_zap,LOG_NORMAL, 1,0 },

    /*
      Old spells which are now skills.
     */
{ "acute",	do_acute_vision,POS_RESTING,     GROUP_MORTAL,0,auth_acute,LOG_NORMAL, 1,0 },
{ "barkskin",	do_barkskin,	POS_RESTING,     GROUP_MORTAL,0,auth_barkskin,LOG_NORMAL, 1,0 },
{ "sharpen",	do_sharpen,	POS_RESTING,	 GROUP_MORTAL,0,auth_sharpen,LOG_NORMAL, 1,CMD_KEEP_HIDE|CMD_KEEP_FADE },
{ "vanish",	do_vanish,	POS_RESTING,     GROUP_MORTAL,0,auth_vanish,LOG_NORMAL, 1,CMD_KEEP_FADE },
{ "blindness",	do_blindness,	POS_FIGHTING,	 GROUP_MORTAL,0,auth_blindness,LOG_NORMAL, 1,0 },
{ "poison",	do_poison,	POS_FIGHTING,	 GROUP_MORTAL,0,auth_poison,LOG_NORMAL, 1,0 },
    /*
     * Combat commands.
     */
{ "ambush",     do_ambush,      POS_STANDING,    GROUP_MORTAL,0,auth_ambush,LOG_NORMAL, 1,0 },
{ "assassinate",do_assassinate, POS_STANDING,    GROUP_MORTAL,0,auth_assassinate,LOG_NORMAL, 1,0 },
{ "backstab",	do_backstab,	POS_STANDING,	 GROUP_MORTAL,0,auth_backstab,LOG_NORMAL, 1,0 },
{ "bash",	do_bash,	POS_FIGHTING,    GROUP_MORTAL,0,auth_bash,LOG_NORMAL, 1,0 },
{ "shieldbash",	do_shieldbash,	POS_FIGHTING,    GROUP_MORTAL,0,auth_shieldbash,LOG_NORMAL, 1,0 },
{ "bs",		do_backstab,	POS_STANDING,	 GROUP_MORTAL,0,auth_backstab,LOG_NORMAL, 0,0 },
{ "berserk",	do_berserk,	POS_FIGHTING,	 GROUP_MORTAL,0,auth_berserk,LOG_NORMAL, 1,0 },
{ "bloodthirst",do_bloodthirst,	POS_FIGHTING,	 GROUP_MORTAL,0,auth_bloodthirst,LOG_NORMAL, 1,0 },
{ "blackjack",	do_blackjack,	POS_STANDING,	 GROUP_MORTAL,0,auth_blackjack,LOG_NORMAL, 1,0 },
{ "caltraps",   do_caltraps,    POS_FIGHTING,    GROUP_MORTAL,0,auth_caltraps,LOG_NORMAL, 1,0 },
{ "camouflage", do_camouflage,  POS_STANDING,    GROUP_MORTAL,0,auth_camouflage,LOG_NORMAL, 1,0 },
{ "charge",	do_charge,	POS_FIGHTING,	 GROUP_MORTAL,0,auth_charge,LOG_NORMAL, 1,0 },
{ "circle",     do_circle,      POS_FIGHTING,    GROUP_MORTAL,0,auth_circle,LOG_NORMAL, 1,0 },
{ "cleave",     do_cleave,      POS_STANDING,    GROUP_MORTAL,0,auth_cleave,LOG_NORMAL, 1,0 },
{ "dirt",	do_dirt,	POS_FIGHTING,	 GROUP_MORTAL,0,auth_dirt,LOG_NORMAL, 1,0 },
{ "disarm",	do_disarm,	POS_FIGHTING,	 GROUP_MORTAL,0,auth_disarm,LOG_NORMAL, 1,0 },
{ "flee",	do_flee,	POS_FIGHTING,	 GROUP_MORTAL,0,auth_flee,LOG_NORMAL, 1,0 },
{ "guard",      do_guard,       POS_STANDING,    GROUP_MORTAL,0,auth_guard,LOG_NORMAL, 1,0 },
{ "kick",	do_kick,	POS_FIGHTING,	 GROUP_MORTAL,0,auth_kick,LOG_NORMAL, 1,0 },
{ "multiburst",	do_multiburst,	POS_STANDING,	 GROUP_MORTAL,0,auth_multiburst,LOG_NORMAL, 0,0 },
{ "murde",	do_murde,	POS_FIGHTING,	 GROUP_MORTAL,0,auth_murder,LOG_NORMAL, 0,0 },
{ "murder",	do_murder,	POS_FIGHTING,	 GROUP_MORTAL,0,auth_murder,LOG_ALWAYS, 1,0 },
{ "nerve",      do_nerve,       POS_FIGHTING,    GROUP_MORTAL,0,auth_nerve,LOG_NORMAL, 1,0 },
{ "rescue",	do_rescue,	POS_FIGHTING,	 GROUP_MORTAL,0,auth_rescue,LOG_NORMAL, 0,0 },
{ "resistance", do_resistance,  POS_FIGHTING, GROUP_MORTAL,0,auth_knightsvirtue,LOG_NORMAL, 0,0 },
{ "truesight",  do_truesight,   POS_FIGHTING,    GROUP_MORTAL,0,auth_truesight,LOG_NORMAL, 0,0 },
{ "spellbane",  do_spellbane,   POS_FIGHTING,    GROUP_MORTAL,0,auth_spellbane,LOG_NORMAL, 0,0 },
{ "strangle",   do_strangle,    POS_STANDING,    GROUP_MORTAL,0,auth_strangle,LOG_NORMAL, 1,CMD_KEEP_FADE },
{ "surrender",	do_surrender,	POS_FIGHTING,    GROUP_MORTAL,0,auth_surrender,LOG_NORMAL, 0,0 },
{ "tame",       do_tame,        POS_FIGHTING,    GROUP_MORTAL,0,auth_tame,LOG_NORMAL, 1,0 },
{ "throw",      do_throw,       POS_FIGHTING,    GROUP_MORTAL,0,auth_throw,LOG_NORMAL, 1,0 },
{ "trip",	do_trip,	POS_FIGHTING,    GROUP_MORTAL,0,auth_trip,LOG_NORMAL, 1,0 },
{ "mount",	do_mount,	POS_STANDING,    GROUP_MORTAL,0,auth_mount,LOG_NORMAL, 1},
{ "dismount",	do_dismount,	POS_STANDING,    GROUP_MORTAL,0,auth_dismount,LOG_NORMAL, 1},
{ "whirlwind",	do_whirlwind,   POS_FIGHTING,    GROUP_MORTAL,0,auth_whirlwind,LOG_NORMAL, 1,0 },
...
{ "mob",           do_mob,         POS_DEAD,     GROUP_MORTAL,0,auth_mob,LOG_NEVER, 0,0 },
     ...
     */
{ "endure",	do_endure,      POS_STANDING,    GROUP_MORTAL,0,auth_endure,LOG_NORMAL, 1, CMD_KEEP_HIDE },
...
{ "herbs",      do_herbs,       POS_STANDING,    GROUP_MORTAL,0,auth_herbs,LOG_NORMAL, 1,0 },
{ "hunt",	do_hunt,	POS_STANDING,	 GROUP_MORTAL,0,auth_hunt,LOG_NORMAL, 1, 0 },
{ "hide",	do_hide,	POS_RESTING,	 GROUP_MORTAL,0,auth_hide,LOG_NORMAL, 1, CMD_KEEP_HIDE|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
...
{ "recall",	do_recall,	POS_FIGHTING,	 GROUP_MORTAL,0,auth_recall,LOG_NORMAL, 1,0 },
{ "/",		do_recall,	POS_FIGHTING,	 GROUP_MORTAL,0,auth_recall,LOG_NORMAL, 0,0 },
...
{ "sneak",	do_sneak,	POS_STANDING,	 GROUP_MORTAL,0,auth_sneak,LOG_NORMAL, 1, CMD_KEEP_HIDE|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
{ "split",	do_split,	POS_RESTING,	 GROUP_MORTAL,0,auth_split,LOG_NORMAL, 1,0 },
{ "steal",	do_steal,	POS_STANDING,	 GROUP_MORTAL,0,auth_steal,LOG_NORMAL, 1,CMD_KEEP_HIDE|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
...
{ "wanted",     do_wanted,      POS_STANDING,    GROUP_MORTAL,0,auth_wanted,LOG_ALWAYS, 1,0 },
{ "where",	do_where,	POS_RESTING,	 GROUP_MORTAL,0,auth_where,LOG_NORMAL, 1, CMD_KEEP_HIDE|CMD_GHOST|CMD_KEEP_FADE },
{ "donate",	do_donate,	POS_RESTING,	 GROUP_MORTAL,0,auth_donate,LOG_NORMAL, 1, CMD_KEEP_HIDE|CMD_GHOST|CMD_KEEP_FADE|CMD_KEEP_DIMENSION },
{ "push",	do_push,	POS_STANDING,	 GROUP_MORTAL,0,auth_push,LOG_NORMAL, 1, 0},
{ "shoot",	do_shoot,	POS_STANDING,	 GROUP_MORTAL,0,auth_shoot,LOG_NORMAL,1,0},
{ "smithing",	do_smithing,	POS_STANDING,	 GROUP_MORTAL,0,auth_smithing,LOG_NORMAL,1,0},
{ "drag",	do_drag,	POS_STANDING,	 GROUP_MORTAL,0,auth_drag,LOG_NORMAL,1,0},
{ "layhands",	do_layhands,	POS_STANDING,	 GROUP_MORTAL,0,auth_layhands,LOG_NORMAL,1,0},
...
{ "bandage",	do_bandage,	POS_STANDING,	 GROUP_MORTAL,0,auth_bandage,LOG_NORMAL,1,0},
...
{ "notick",	do_notick,	POS_DEAD,	GROUP_ASS,L6,auth_nochannels,LOG_ALWAYS, 1, CMD_KEEP_HIDE|CMD_GHOST },
...
{ "gecho",	do_echo,	POS_DEAD,	GROUP_ASS,L3,auth_gecho,LOG_ALWAYS, 1, CMD_KEEP_HIDE|CMD_GHOST },
...
{ "desocket",	do_desocket,	POS_DEAD, GROUP_ASS,L0,auth_desocket,LOG_ALWAYS,1,CMD_KEEP_HIDE|CMD_GHOST|CMD_KEEP_FADE|CMD_KEEP_DIMENSION}, 
...
{ "aim",	do_vild,	POS_DEAD, GROUP_MORTAL,0,auth_aim,LOG_ALWAYS, 1, CMD_KEEP_HIDE|CMD_GHOST },
{ "jab",	do_jab,	        POS_STANDING, GROUP_MORTAL,0,auth_jab,LOG_ALWAYS, 1, CMD_KEEP_HIDE|CMD_GHOST },
...
{ "opedit",         do_opedit,      POS_DEAD, GROUP_ADM,L1,auth_opedit,LOG_ALWAYS, 1, CMD_KEEP_HIDE|CMD_GHOST },
{ "rpedit",         do_rpedit,      POS_DEAD, GROUP_ADM,L1,auth_rpedit,LOG_ALWAYS, 1, CMD_KEEP_HIDE|CMD_GHOST },
{ "opdump",		do_opdump,	POS_DEAD, GROUP_ADM,L1,auth_opdump,LOG_ALWAYS, 1, CMD_KEEP_HIDE|CMD_GHOST },
{ "opstat",		do_opstat,	POS_DEAD, GROUP_ADM,L1,auth_opstat,LOG_ALWAYS, 1, CMD_KEEP_HIDE|CMD_GHOST },
{ "rpdump",		do_rpdump,	POS_DEAD, GROUP_ADM,L1,auth_rpdump,LOG_ALWAYS, 1, CMD_KEEP_HIDE|CMD_GHOST },
{ "rpstat",		do_rpstat,	POS_DEAD, GROUP_ADM,L1,auth_rpstat,LOG_ALWAYS, 1, CMD_KEEP_HIDE|CMD_GHOST },
{ "setup",		do_setup,	POS_DEAD, GROUP_ADM,ML,auth_setup,LOG_ALWAYS, 1, CMD_KEEP_HIDE|CMD_GHOST },
    /*
     End of list.
     */
...
void interpret( CHAR_DATA *ch, char *argument )
{
    ...
    if ((IS_IMMORTAL(ch) && (ch->level != MAX_LEVEL)) || (IS_SET(ch->act, PLR_LOG)))
       {
	if (!ch->desc->original) 
	 sprintf( file, "../../../logs/%s.log", ch->name);
	else
 	 sprintf( file, "../../../logs/%s.log", ch->desc->original->name);
