    ...
    if (arg[0] == '\0')
     {
      ...
      return;
	     ...
	     if (!strcmp(arg, "gondor")) 	{kingdom=1;}
	else if (!strcmp(arg, "aldon")) 	{kingdom=2;}
	else if (!strcmp(arg, "mordukhan")) 	{kingdom=3;}
	else if (!strcmp(arg, "drakkon")) 	{kingdom=4;}
	else if (!strcmp(arg, "narssius")) 	{kingdom=5;}
	else if (!strcmp(arg, "arkadia")) 	{kingdom=6;}
	else if (!strcmp(arg, "talastin"))	{kingdom=7;}
