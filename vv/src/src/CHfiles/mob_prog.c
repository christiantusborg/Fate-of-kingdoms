...
int clan_lookup (const char *name)
{
	int clan;
	     ...
	     if (!strcmp(name, "gondor")) 	{clan=1;}
	else if (!strcmp(name, "aldon")) 	{clan=2;}
	else if (!strcmp(name, "mordukhan")) 	{clan=3;}
	else if (!strcmp(name, "arkadia")) 	{clan=4;}
	else if (!strcmp(name, "narssius")) 	{clan=5;}
	else if (!strcmp(name, "arkadia")) 	{clan=6;}
	else if (!strcmp(name, "talastin"))	{clan=7;}
