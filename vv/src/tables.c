...
const struct flag_type class_flags[] =
 { 
    ...
    {  "mercenary",		CLASS_MERCENARY,	TRUE	},
...
const struct flag_type wear_flags[] =
 {
     ...
     {	"saddle",		ITEM_WEAR_SADDLE,	TRUE	},
     {	"hoof",			ITEM_WEAR_HOOF,		TRUE	},
     {	"tailpiece",		ITEM_WEAR_TAILPIECE,	TRUE	},
     {	"horn",			ITEM_WEAR_HORN,		TRUE	},
 ...
 const struct flag_type wear_loc_strings[] =
 {
     ...
     {	"on the hands",		WEAR_HANDS_1,	TRUE	},
     {	"on the lower hands",	WEAR_HANDS_2,	TRUE	},
     {	"on the arms",		WEAR_ARMS_1,	TRUE	},
     {	"on the lower arms",	WEAR_ARMS_2,	TRUE	},
     {	"as a shield",		WEAR_SHIELD,	TRUE	},
     {	"about the shoulders",	WEAR_ABOUT,	TRUE	},
     {	"on the back",		WEAR_SADDLE,	TRUE	},
     {	"on the hooves",	WEAR_HOOF,	TRUE	},
     {	"on the tail",		WEAR_TAIL,	TRUE	},
     {	"on the horns",		WEAR_HORN,	TRUE	},
     {	"around the waist",	WEAR_WAIST,	TRUE	},
     {	"on the left wrist",	WEAR_WRIST_1,	TRUE	},
     {	"on the right wrist",	WEAR_WRIST_2,	TRUE	},
     {	"on the lower right wrist",	WEAR_WRIST_3,	TRUE	},
     {	"on the lower right wrist",	WEAR_WRIST_4,	TRUE	},          
 ...
 const struct flag_type wear_loc_flags[] =
 {
     ...
     {	"legs",		WEAR_LEGS,	TRUE	},
     {	"feet",		WEAR_FEET,	TRUE	},
     {	"hands",	WEAR_HANDS_1,	TRUE	},
     {	"hands",	WEAR_HANDS_2,	TRUE	},
     {	"arms",		WEAR_ARMS_1,	TRUE	},
     {	"arms",		WEAR_ARMS_2,	TRUE	},
     {	"shield",	WEAR_SHIELD,	TRUE	},
     {	"about",	WEAR_ABOUT,	TRUE	},
     {	"back",		WEAR_SADDLE,	TRUE	},
     {	"hooves",	WEAR_HOOF,	TRUE	},
     {	"tail",		WEAR_TAIL,	TRUE	},
     {	"horns",	WEAR_HORN,	TRUE	},
     {	"waist",	WEAR_WAIST,	TRUE	},
     {	"lwrist",	WEAR_WRIST_1,	TRUE	},
     {	"rwrist",	WEAR_WRIST_2,	TRUE	},
     {	"llwrist",	WEAR_WRIST_3,	TRUE	},
     {	"lrwrist",	WEAR_WRIST_4,	TRUE	},
     {	"wielded",	WEAR_WIELD,	TRUE	},
 ...
 const struct flag_type vuln_new_flags[] =
 {
     {	"summon",	 0,		TRUE	},
     {   "charm",         1,            TRUE    },
     {   "magic",         2,            TRUE    },
...
const struct flag_type rprog_flags[] =
{
 ...
 const struct res_imm_type res_imm_flags[MAX_RESISTANCE] =
 {
     {	"summon"		}, //1
     {   "charm"          },  //2
     {   "magic"           }, //3
 ...
 struct	bloodline_type bloodline_table  [] =
{
 {"Court Fool"	,100},  
 {"Slave"	,99 },
 {"Soldier"	,97 },
...
struct	religion_type religion_table [] =
{
 {"aaa"	,1 },
 {"bbb"	,1 },
 {"Ccc"	,0 },
...
struct    stat_type stat_table [MAX_STATS] =
{
//name
  {"","str",STAT_STR},
  {"","int",STAT_INT},
