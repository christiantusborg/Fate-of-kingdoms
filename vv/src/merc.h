...
#define MAX_RESISTANCE	   23
#define MAX_IMMUNITIES     23
...
#define CON_GET_NAME		 -19
#define CON_GET_OLD_PASSWORD	 -18
#define CON_UNIVERSAL		 -17

#define CON_CONFIRM_NEW_NAME	 -16
#define CON_GET_NEW_PASSWORD	 -15
#define CON_CONFIRM_NEW_PASSWORD -14
#define CON_GET_NEW_RACE	 -13
#define CON_GET_NEW_SEX		 -12
#define CON_GET_NEW_CLASS	 -11
#define CON_ROLL_STATS           -10
#define CON_ACCEPT_STATS         -9
#define CON_GET_ALIGNMENT	 -8
#define CON_GET_ETHOS            -7
#define CON_BLOODLINE		 -6
#define CON_DEITY		 -5
#define CON_PICK_HOMETOWN        -4
#define CON_PICK_WEAPON		 -3
#define CON_READ_IMOTD		 -2
...
#define MAIN_MENU                 2
#define CON_NOTEWRITE		  3
#define CON_IRL			  4
#define CON_SETWIZILEVEL	  5
#define CON_NOTE_TO		  6
#define CON_NOTE_SUBJECT	  7
#define CON_NOTE_EXPIRE	          8
#define CON_NOTE_TEXT		  9
#define CON_NOTE_FINISH	          10
...
#define ITEM_WEAR_HORN		(T)
#define ITEM_WEAR_HOOF		(U)
#define ITEM_WEAR_TAILPIECE	(V)
#define ITEM_WEAR_SADDLE	(W)
...
#define WEAR_LEGS		     10
#define WEAR_FEET		     11
#define WEAR_HANDS_1		     12
#define WEAR_ARMS_1		     13
#define WEAR_SHIELD		     14
#define WEAR_ABOUT		     15
#define WEAR_WAIST		     16
#define WEAR_WRIST_1		     17
#define WEAR_WRIST_2		     18
#define WEAR_HOLD		     19
#define WEAR_WIELD		     20
#define WEAR_SECONDARY		     21
/* defines a wear loc for tattoos */
#define WEAR_TATTOO		     22
#define WEAR_WRIST_3		     23
#define WEAR_WRIST_4		     24
#define WEAR_ARMS_2		     25
#define WEAR_HANDS_2		     26
#define WEAR_HOOF		     27
#define WEAR_SADDLE		     28
#define WEAR_HORN		     29
#define WEAR_TAIL		     30
#define WEAR_STUCK_IN                31
#define MAX_WEAR		     32
...
#define auth_opedit 	383
#define auth_rpedit	384
#define auth_opdump	385
#define auth_opstat	386
#define auth_rpdump	387
#define auth_rpstat	388
...
//    MPROG_LIST *        mprogs;    
    ...
    sh_int                practicer;
    long               mprog_flags;    
    sh_int	       resistance[MAX_RESISTANCE];
    sh_int	       immuniti[MAX_RESISTANCE];        
};
...
struct    skill_type
{
    ...
    sh_int    mastery[MAX_CLASS];   
    sh_int    skill_race[MAX_PC_RACE]; 
...
#define PERS(ch, looker)        ( can_see( looker, (ch) ) ?         \
                                ...
                                : ( (ch)->level > 86 ? "A divine being" :"someone") )
...
extern		struct	bloodline_type bloodline_table  [];
extern  const	struct	spec_type	spec_table	[];
extern	const	struct	liq_type	liq_table	[];

extern	struct	abilities_type	skill_table	[MAX_SKILL];
//extern	struct	skill_type	skill_table	[MAX_SKILL];
extern  const   struct  hometown_type   hometown_table  [];
extern     struct  religion_type   religion_table  [];
...
/* random.c */
void wield__magic(CHAR_DATA *mob);
