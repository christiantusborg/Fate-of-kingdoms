...
/* commented out for now, till i fgure how to do it
   level 1 people dont have this stuff allocated right or something
   i have to learn to set it default somewhere
    free_string(pcdata->sign);
    free_string(pcdata->background);
*/
...
BUFFER *new_buf()
{
    ...
    buffer->size	= get_size(2*BASE_BUF);
