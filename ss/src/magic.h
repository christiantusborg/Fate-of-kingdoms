...
DECLARE_SPELL_FUN(  spell_misery  );
DECLARE_SPELL_FUN(	spell_life_leech	);
//DECLARE_SPELL_FUN(	spell_shield_of_vengeance	);

DECLARE_SPELL_FUN(	spell_cure_minor_wounds	);
DECLARE_SPELL_FUN(	spell_cure_light_wounds	);
DECLARE_SPELL_FUN(	spell_cure_moderate_wounds	);
DECLARE_SPELL_FUN(	spell_cure_serious_wounds	);
DECLARE_SPELL_FUN(	spell_cure_critical_wounds	);
DECLARE_SPELL_FUN(	spell_cure_heal_wounds	);
